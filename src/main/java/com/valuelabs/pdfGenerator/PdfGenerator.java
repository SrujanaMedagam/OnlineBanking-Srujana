...
public class PdfGenerator {
    ...
    public void  main(java.util.List transactionHistory) {
        try {
    ...
    private static void createTable(java.util.List transactionHistory)
            throws BadElementException {        PdfPTable table = new PdfPTable(5);
        ...
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
         c1 = new PdfPCell(new Phrase("ToAccount"));
        c1.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(c1);
       ...
       // table.addCell(c1);
        ...
        for(Object l: transactionHistory){
        	AccountTransactionDetails list=(AccountTransactionDetails)l;
           	table.addCell(list.getAccountNumber());
            table.addCell(list.getTransactionDate());
           // table.addCell(list.getAmount());
            table.addCell(list.getTransactionType());
            table.addCell(list.getToAccount());
        }
